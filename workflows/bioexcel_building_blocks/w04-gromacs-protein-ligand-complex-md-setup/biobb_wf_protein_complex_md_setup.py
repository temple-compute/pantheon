# -*- coding: utf-8 -*-
"""biobb_wf_protein-complex_md_setup.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/bioexcel/biobb_wf_protein-complex_md_setup/blob/main/biobb_wf_protein-complex_md_setup/notebooks/biobb_wf_protein-complex_md_setup.ipynb
...
if 'google.colab' in sys.modules:
  ...
  !/usr/local/miniforge/condabin/mamba create -f biobb_wf_protein-complex_md_setup/conda_env/environment.yml -y
#   %env PATH=/usr/local/bin:/opt/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/tools/node/bin:/tools/google-cloud-sdk/bin:/usr/local/miniforge/envs/biobb_wf_protein-complex_md_setup/bin
  _ = (sys.path.append("/usr/local/miniforge/envs/biobb_wf_protein-complex_md_setup/lib/python3.12/site-packages/"))
  from google.colab import output
  output.enable_custom_widget_manager()
  os.chdir("/content/biobb_wf_protein-complex_md_setup/biobb_wf_protein-complex_md_setup/notebooks")
